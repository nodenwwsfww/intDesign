! function (t) {
    ...
    var r = e(1),
        ...
        a = function (t, n, e) {
            ...
            for (s in v && (e = n), e) l = ((f = !p && m && void 0 !== m[s]) ? m : e)[s], h = g && f ? c(l, r) : y && "function" == typeof l ? c(Function.call, l) : l, m && u(m, s, l, t & a.U), b[s] != l && i(b, s, h), y && w[s] != l && (w[s] = l)
        };
    ...
    if (e(8)) {
        var r = e(30),
            ...
            It = function () {
                return pt.apply(Lt ? lt.call(At(this)) : At(this), arguments)
            },
            Nt = {
                ...
                filter: function (t) {
                    return Ft(this, K(At(this), t, arguments.length > 1 ? arguments[1] : void 0))
                },
                find: function (t) {
            ...
            Rt = function (t, n) {
                return Ft(this, lt.call(At(this), t, n))
            },
            kt = function (t) {
                At(this);
        ...
        p(Wt, Ct), h(Wt, vt, Ct.values), p(Wt, {
            ...
            b ? (v = e((function (t, e, r, o) {
                ...
                var i, u, c, a, l = 0,
                    p = 0;
                if (x(e)) {
                    if (!(e instanceof Y || "ArrayBuffer" == (a = w(e)) || "SharedArrayBuffer" == a)) return bt in e ? Mt(v, e) : Pt.call(v, e);
                    i = e, p = Et(r, n);
                    var g = e.byteLength;
                    if (void 0 === o) {
                ...
                var i;
                return f(t, v, s), x(e) ? e instanceof Y || "ArrayBuffer" == (i = w(e)) || "SharedArrayBuffer" == i ? void 0 !== o ? new g(e, Et(r, n), o) : void 0 !== r ? new g(e, Et(r, n)) : new g(e) : bt in e ? Mt(v, e) : Pt.call(v, e) : new g(y(e))
            ...
            var M = _[vt],
                ...
                P = Ct.values;
            h(v, yt, !0), h(_, bt, s), h(_, wt, !0), h(_, gt, v), (a ? new v(1)[dt] == s : dt in _) || W(_, dt, {
                get: function () {
                    return s
                }
                ...
                from: Pt,
                of: jt
            }), "BYTES_PER_ELEMENT" in _ || h(_, "BYTES_PER_ELEMENT", n), u(u.P, s, Nt), k(s), u(u.P + u.F * _t, s, {
                set: kt
            }), u(u.P + u.F * !T, s, Ct), r || _.toString == ht || (_.toString = ht), u(u.P + u.F * i((function () {
                new v(1).slice()
            })), s, {
                slice: Rt
    ...
    t.exports = function (t, n, e, d, y, g) {
        ...
        if ("function" == typeof b && (g || x.forEach && !l((function () {
            ...
            }))).prototype = x, x.constructor = b), (O || M) && (_("delete"), _("has"), y && _("get")), (M || A) && _(w), g && x.clear && delete x.clear
    ...
    function e(t, n, e) {
        t.self === t ? t.scrollTo(n, e) : (t.scrollLeft = n, t.scrollTop = e)
    }
    ...
    function r(t) {
        ...
        if (n) {
            var o = n.maxSynchronousAlignments,
                i = function (t, n) {
                    var e, r, o, i, u, c, a, s = t.align,
                        f = t.target.getBoundingClientRect(),
                        l = s && null != s.left ? s.left : .5,
                        h = s && null != s.top ? s.top : .5,
                        p = s && null != s.leftOffset ? s.leftOffset : 0,
                        v = s && null != s.topOffset ? s.topOffset : 0,
                        d = l,
                        y = h;
                    if (t.isWindow(n)) c = Math.min(f.width, n.innerWidth), a = Math.min(f.height, n.innerHeight), r = f.left + n.pageXOffset - n.innerWidth * d + c * d, o = f.top + n.pageYOffset - n.innerHeight * y + a * y, o -= v, i = (r -= p) - n.pageXOffset, u = o - n.pageYOffset;
                    else {
                        c = f.width, a = f.height, e = n.getBoundingClientRect();
                        var g = f.left - (e.left - n.scrollLeft),
                            m = f.top - (e.top - n.scrollTop);
                        r = g + c * d - n.clientWidth * d, o = m + a * y - n.clientHeight * y, r -= p, o -= v, r = Math.max(Math.min(r, n.scrollWidth - n.clientWidth), 0), o = Math.max(Math.min(o, n.scrollHeight - n.clientHeight), 0), i = r - n.scrollLeft, u = o - n.scrollTop
                    }
                    return {
                        x: r,
                        y: o,
                ...
                u = Date.now() - n.startTime,
                c = Math.min(1 / n.time * u, 1);
            if (n.endIterations >= o) return e(t, i.x, i.y), t._scrollSettings = null, n.end("complete");
            var a = 1 - n.ease(c);
            if (e(t, i.x - i.differenceX * a, i.y - i.differenceY * a), u >= n.time) return n.endIterations++, r(t);
            ! function (t) {
    ...
    function i(t, n, e, i) {
        ...
        function l(t) {
            n._scrollSettings = null, n.parentElement && n.parentElement._scrollSettings && n.parentElement._scrollSettings.end(t), e.debug && console.log("Scrolling ended with type", t, "for", n), i(t), u && (n.removeEventListener("touchstart", u, f), n.removeEventListener("wheel", u, f))
        }
        a && a.end("canceled");
        var h = e.maxSynchronousAlignments;
        null == h && (h = 3), n._scrollSettings = {
            startTime: s,
            endIterations: 0,
            target: t,
            time: e.time,
            ease: e.ease,
            align: e.align,
            isWindow: e.isWindow || o,
            maxSynchronousAlignments: h,
            end: l
        }, "cancellable" in e && !e.cancellable || (u = l.bind(null, "canceled"), n.addEventListener("touchstart", u, f), n.addEventListener("wheel", u, f)), c && r(n)
    }
    ...
    function a(t) {
        ...
        if (t.getRootNode) {
            var n = t.getRootNode();
            if (11 === n.nodeType) return n.host
        }
    }
    t.exports = function (t, n, e) {
        if (t) {
            "function" == typeof n && (e = n, n = null), n || (n = {}), n.time = isNaN(n.time) ? 1e3 : n.time, n.ease = n.ease || function (t) {
            ...
            var r = a(t),
                ...
                s = n.validTarget || c,
                f = n.isScrollable;
            for (n.debug && (console.log("About to scroll to", t), r || console.error("Target did not have a parent, is it mounted in the DOM?")); r;)
                if (n.debug && console.log("Scrolling parent node", r), s(r, o) && (f ? f(r, u) : u(r)) && (o++, i(t, r, n, l)), !(r = a(r))) {
                    l("complete");
                    break
                }
        }
    ...
    t.exports = function (t, n, e, v, d, y, g) {
        ...
        var m, b, w, x = function (t) {
            ...
            E = !1,
            A = t.prototype,
            O = A[l] || A["@@iterator"] || d && A[d],
            F = O || x(d),
            M = d ? _ ? x("entries") : F : void 0,
            T = "Array" == n && A.entries || O;
        if (T && (w = f(T.call(new t))) !== Object.prototype && w.next && (s(w, S, !0), r || "function" == typeof w[l] || u(w, l, p)), _ && O && "values" !== O.name && (E = !0, F = function () {
                return O.call(this)
            }), r && !g || !h && !E && A[l] || u(A, l, F), c[n] = F, c[S] = p, d)
            if (m = {
                    values: _ ? F : x("values"),
                    keys: y ? F : x("keys"),
                    entries: M
                }, g)
                for (b in m) b in A || i(A, b, m[b]);
    ...
    function L(t, n, e) {
        var r, o, i, u = new Array(e),
            ...
            l = 0,
            h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for ((t = E(t)) != t || t === S ? (o = t != t ? 1 : 0, r = a) : (r = O(F(t) / M), t * (i = A(2, -r)) < 1 && (r--, i *= 2), (t += r + s >= 1 ? f / i : f * A(2, 1 - s)) * i >= 2 && (r++, i /= 2), r + s >= a ? (o = 0, r = a) : r + s >= 1 ? (o = (t * i - 1) * A(2, n), r += s) : (o = t * A(2, s - 1) * A(2, n), r = 0)); n >= 8; u[l++] = 255 & o, o /= 256, n -= 8);
    ...
    function U(t, n, e, r, o, i) {
        ...
        for (var c = t[T]._b, a = u + t[j], s = r(+o), f = 0; f < n; f++) c[a + f] = s[i ? f : n - f - 1]
    }
    if (u.ABV) {
        if (!s((function () {
                m(1)
            ...
            for (var G, V = (m = function (t) {
                    return f(this, m), new _(p(t))
                }).prototype = _.prototype, H = v(_), X = 0; H.length > X;)(G = H[X++]) in m || c(m, G, _[G]);
            i || (V.constructor = m)
        }
        var Y = new b(new m(2)),
        ...
        this[T] = t, this[j] = o, this[P] = e
    }, o && (q(m, "byteLength", "_l"), q(b, "buffer", "_b"), q(b, "byteLength", "_l"), q(b, "byteOffset", "_o")), a(b.prototype, {
        getInt8: function (t) {
    ...
    t.exports = !s || e(2)((function () {
        ...
        for (var e = c(t), s = arguments.length, f = 1, l = i.f, h = u.f; s > f;)
            for (var p, v = a(arguments[f++]), d = l ? o(v).concat(l(v)) : o(v), y = d.length, g = 0; y > g;) p = d[g++], r && !h.call(v, p) || (e[p] = v[p]);
        return e
    } : s
}, function (t, n) {
    ...
    var r, o, i, u, c = e(30),
        ...
        j = !! function () {
            try {
                ...
                return (M || "function" == typeof PromiseRejectionEvent) && t.then(T) instanceof n && 0 !== O.indexOf("6.6") && -1 === x.indexOf("Chrome/66")
            } catch (t) {}
        }(),
        L = function (t) {
            var n;
                ...
                m((function () {
                    for (var r = t._v, o = 1 == t._s, i = 0, u = function (n) {
                            var e, i, u, c = o ? n.ok : n.fail,
                                ...
                                f = n.domain;
                            try {
                                c ? (o || (2 == t._h && k(t), t._h = 1), !0 === c ? e = r : (f && f.enter(), e = c(r), f && (f.exit(), u = !0)), e === n.promise ? s(_("Promise-chain cycle")) : (i = L(e)) ? i.call(e, a, s) : a(e)) : s(r)
                            } catch (t) {
                                f && !u && f.exit(), s(t)
                            }
                        }; e.length > i;) u(e[i++]);
        ...
        N = function (t) {
            g.call(a, (function () {
                var n, e, r, o = t._v,
                    i = R(t);
                if (i && (n = w((function () {
                        M ? E.emit("unhandledRejection", o, t) : (e = a.onunhandledrejection) ? e({
                            promise: t,
                            reason: o
    ...
    j || (F = function (t) {
        ...
        Promise: F
    }), e(38)(F, "Promise"), e(41)("Promise"), u = e(7).Promise, l(l.S + l.F * !j, "Promise", {
        reject: function (t) {
            var n = P(this);
    ...
    "use strict";
    e(124);
    var r, o = (r = e(296)) && r.__esModule ? r : {
        default: r
    };
    ...
    var r = e(1),
        ...
        $ = function (t, n, e) {
            return t === U && $(W, n, e), m(t), n = S(n, !0), m(e), o(q, n) ? (e.enumerable ? (o(t, k) && t[k][n] && (t[k][n] = !1), e = E(e, {
                enumerable: _(0, !1)
            })) : (o(t, k) || j(t, k, _(1, {})), t[k][n] = !0), X(t, n, e)) : j(t, n, e)
        },
        K = function (t, n) {
            m(t);
            for (var e, r = y(n = x(n)), o = 0, i = r.length; i > o;) $(t, e = r[o++], n[e]);
            return t
        },
        J = function (t) {
            var n = D.call(this, t = S(t, !0));
            return !(this === U && o(q, t) && !o(W, t)) && (!(n || !o(this, t) || !o(q, t) || o(this, k) && this[k][t]) || n)
        },
        Z = function (t, n) {
            if (t = x(t), n = S(n, !0), t !== U || !o(q, n) || o(W, n)) {
                var e = P(t, n);
                return !e || !o(q, n) || o(t, k) && t[k][n] || (e.enumerable = !0), e
            }
        },
        Q = function (t) {
            for (var n, e = L(x(t)), r = [], i = 0; e.length > i;) o(q, n = e[i++]) || n == k || n == a || r.push(n);
            return r
        },
        tt = function (t) {
            for (var n, e = t === U, r = L(e ? W : x(t)), i = [], u = 0; r.length > u;) !o(q, n = r[u++]) || e && !o(U, n) || i.push(q[n]);
            return i
        };
    G || (c((I = function () {
        ...
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function (e) {
                this === U && n.call(W, e), o(this, k) && o(this[k], t) && (this[k][t] = !1), X(this, t, _(1, e))
            };
        return i && H && X(U, t, {
            configurable: !0,
            set: n
        ...
        return this._k
    })), O.f = Z, M.f = $, e(34).f = A.f = Q, e(45).f = J, F.f = tt, i && !e(30) && c(U, "propertyIsEnumerable", J, !0), v.f = function (t) {
        return Y(p(t))
    }), u(u.G + u.W + u.F * !G, {
        Symbol: I
    });
    ...
    for (var rt = T(p.store), ot = 0; rt.length > ot;) d(rt[ot++]);
    u(u.S + u.F * !G, "Symbol", {
        for: function (t) {
    ...
    u(u.S + u.F * it, "Object", {
        ...
        stringify: function (t) {
            ...
            if (e = n = r[1], (b(n) || void 0 !== t) && !z(t)) return g(n) || (n = function (t, n) {
                if ("function" == typeof e && (n = e.call(this, t, n)), !z(n)) return n
            }), r[1] = n, R.apply(N, r)
        }
    }), I.prototype[C] || e(14)(I.prototype, C, I.prototype.valueOf), l(I, "Symbol"), l(Math, "Math", !0), l(r.JSON, "JSON", !0)
}, function (t, n, e) {
    ...
    if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
        ...
        for (var b, w = e(8) ? s(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), x = 0; w.length > x; x++) o(v, b = w[x]) && !o(p, b) && l(p, b, f(v, b));
    ...
    o(o.S + o.F * !e(52)((function (t) {
        ...
        from: function (t) {
            ...
            if (y && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == m || p == Array && c(m))
                for (e = new p(n = a(h.length)); n > g; g++) s(e, g, y ? d(h[g], g) : h[g]);
            else
    ...
    e(55)("replace", 2, (function (t, n, e, v) {
        return [function (r, o) {
            ...
            for (var w, x = "", S = 0, _ = 0; _ < m.length; _++) {
                b = m[_];
                for (var E = String(b[0]), A = s(f(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (w = b[F]) ? w : String(w));
                var M = b.groups;
                if (p) {
                    var T = [E].concat(O, A, h);
                    void 0 !== M && T.push(M);
                    var P = String(n.apply(void 0, T))
                } else P = d(E, h, A, O, M, n);
                A >= S && (x += h.slice(S, A) + P, S = A + E.length)
            }
            return x + h.slice(S)
        }];
    ...
    e(55)("split", 2, (function (t, n, e, f) {
        ...
        return d = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[p] || 2 != "ab".split(/(?:ab)*/)[p] || 4 != ".".split(/(.?)(.?)/)[p] || ".".split(/()()/)[p] > 1 || "".split(/.?/)[p] ? function (t, n) {
            ...
            for (var w = 0, x = 0, S = []; x < h.length;) {
                m.lastIndex = v ? x : 0;
                var _, E = a(m, v ? h : h.slice(x));
                if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === w) x = u(h, x, y);
                else {
    ...
    var r = e(86),
        ...
        a = function (t, n, e) {
            ...
            for (s in p && (e = n), e)(f = !h && w && void 0 !== w[s]) && c(m, s) || (l = f ? w[s] : e[s], m[s] = p && "function" != typeof w[s] ? e[s] : y && f ? i(l, r) : g && w[s] == l ? function (t) {
            ...
            }(l) : d && "function" == typeof l ? i(Function.call, l) : l, d && ((m.virtual || (m.virtual = {}))[s] = l, t & a.R && b && !b[s] && u(b, s, l)))
        };
    ...
    (function (n, e) {
        ...
        r = function () {
            ...
            l ? w = function () {
                return n.nextTick(d)
            } : f ? (g = 0, m = new f(d), b = document.createTextNode(""), m.observe(b, {
                characterData: !0
            }), w = function () {
                b.data = g = ++g % 2
            ...
            function A(n, e, r) {
                e.constructor === n.constructor && r === x && e.constructor.resolve === S ? function (t, n) {
                    1 === n._state ? M(t, n._result) : 2 === n._state ? T(t, n._result) : P(n, void 0, (function (n) {
                        return O(t, n)
                    }), (function (n) {
                        return T(t, n)
                    }))
                }(n, e) : void 0 === r ? M(n, e) : t(r) ? function (t, n, e) {
                    c((function (t) {
                        var r = !1,
                            o = function (t, n, e, r) {
                                try {
            ...
            function O(t, n) {
                if (t === n) T(t, new TypeError("You cannot resolve a promise with itself"));
                else if (o = typeof (r = n), null === r || "object" !== o && "function" !== o) M(t, n);
                else {
                    var e = void 0;
                    try {
                        e = n.then
            ...
            function M(t, n) {
                void 0 === t._state && (t._result = n, t._state = 1, 0 !== t._subscribers.length && c(j, t))
            }

            function T(t, n) {
                void 0 === t._state && (t._state = 2, t._result = n, c(F, t))
            }

            function P(t, n, e, r) {
                var o = t._subscribers,
                    i = o.length;
                t._onerror = null, o[i] = n, o[i + 1] = e, o[i + 2] = r, 0 === i && t._state && c(j, t)
            }
            ...
            function j(t) {
                var n = t._subscribers,
                    e = t._state;
                if (0 !== n.length) {
                    for (var r = void 0, o = void 0, i = t._result, u = 0; u < n.length; u += 3) r = n[u], o = n[u + e], r ? L(e, r, o, i) : o(i);
            ...
            function L(n, e, r, o) {
                ...
                if (i) {
                    ...
                    if (e === u) return void T(e, new TypeError("A promises callback cannot return that same promise."))
                } else u = o;
                void 0 !== e._state || (i && a ? O(e, u) : !1 === a ? T(e, c) : 1 === n ? M(e, u) : 2 === n && T(e, u))
            }
            var I = 0;
            ...
            var R = function () {
                    ...
                    return t.prototype._enumerate = function (t) {
                        ...
                        if (r === S) {
                            ...
                            if (o === x && void 0 !== t._state) this._settledAt(t._state, n, t._result);
                            else if ("function" != typeof o) this._remaining--, this._result[n] = t;
                            else if (e === k) {
                                var c = new e(E);
                                u ? T(c, i) : A(c, t, o), this._willSettleAt(c, n)
                        ...
                        var r = this.promise;
                        void 0 === r._state && (this._remaining--, 2 === t ? T(r, e) : this._result[n] = e), 0 === this._remaining && M(r, this._result)
                ...
                k = function () {
                    function n(t) {
                        this[_] = I++, this._result = this._state = void 0, this._subscribers = [], E !== t && ("function" != typeof t && function () {
            ...
            return k.prototype.then = x, k.all = function (t) {
            ...
            }, k.resolve = S, k.reject = function (t) {
                var n = new this(E);
                return T(n, t), n
    ...
    ! function () {
        ...
        if (!self.fetch) {
            ...
            var t = "FileReader" in self && "Blob" in self && function () {
                    try {
                        return new Blob, !0
                    } catch (t) {
                        return !1
            ...
            f.call(l.prototype), f.call(v.prototype), self.Headers = u, self.Request = l, self.Response = v, self.fetch = function (n, e) {
                var o;
                return o = l.prototype.isPrototypeOf(n) && !e ? n : new l(n, e), new fetch.Promise((function (n, e) {
                    var i = function () {
                    ...
                    function u() {
                        if (4 === i.readyState) {
                            ...
                            if (t < 100 || t > 599) e(new TypeError("Network request failed"));
                            else {
                                var r = {
                                        status: t,
                    ...
                    "cors" === o.credentials && (i.withCredentials = !0), i.onreadystatechange = u, self.usingActiveXhr || (i.onload = u, i.onerror = function () {
                        e(new TypeError("Network request failed"))
                    }), i.open(o.method, o.url, !0), "responseType" in i && t && (i.responseType = "blob"), o.headers.forEach((function (t, n) {
        ...
        function f() {
            return this.bodyUsed = !1, this._initBody = function (e) {
                ...
                var t, n, e = c(this);
                if (e) return e;
                if (this._bodyBlob) return t = this._bodyBlob, (n = new FileReader).readAsText(t), a(n);
        ...
        function l(t, n) {
            var r, o;
            if (n = n || {}, this.url = t, this.credentials = n.credentials || "omit", this.headers = new u(n.headers), this.method = (r = n.method || "GET", o = r.toUpperCase(), e.indexOf(o) > -1 ? o : r), this.mode = n.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && n.body) throw new TypeError("Body not allowed for GET or HEAD requests");
        ...
        function v(t, n) {
            n || (n = {}), this._initBody(t), this.type = "default", this.url = null, this.status = n.status, this.ok = this.status >= 200 && this.status < 300, this.statusText = n.statusText, this.headers = n.headers instanceof u ? n.headers : new u(n.headers), this.url = n.url || ""
        }
    }()
}, function (t, n, e) {
    (function (t) {
        ! function () {
            ...
            var r = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, n, e) {
                return t == Array.prototype || t == Object.prototype || (t[n] = e.value), t
            };
            var o, i = function (n) {
                n = ["object" == typeof globalThis && globalThis, n, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof t && t];
            ...
            function u(t, n) {
                if (n) {
                    for (var e = i, o = t.split("."), u = 0; u < o.length - 1; u++) {
                        var c = o[u];
                        c in e || (e[c] = {}), e = e[c]
                    }(c = n(u = e[o = o[o.length - 1]])) != u && null != c && r(e, o, {
                        configurable: !0,
                        writable: !0,
                        value: c
                    })
            ...
            if (u("Symbol", (function (t) {
                    function n(t, n) {
                        this.o = t, r(this, "description", {
                            configurable: !0,
                            writable: !0,
                            value: n
                        })
                    ...
                    return function t(r) {
                        ...
                        return new n("jscomp_symbol_" + (r || "") + "_" + e++, r)
                    }
                })), u("Symbol.iterator", (function (t) {
                    if (t) return t;
                    ...
                    for (var n = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), o = 0; o < n.length; o++) {
                        var u = i[n[o]];
                        "function" == typeof u && "function" != typeof u.prototype[t] && r(u.prototype, t, {
                            configurable: !0,
                            writable: !0,
                            value: function () {
                                return c(e(this))
            ...
            function g(t) {
                for (; t.a.b;) try {
                    ...
                    t.a.m = void 0, t.a.j(n)
                }
                if (t.a.h = !1, t.a.g) {
                    if (n = t.a.g, t.a.g = null, n.A) throw n.w;
                    return {
                        value: n.return,
                        done: !0
                    }
            ...
            function m(t) {
                this.next = function (n) {
                    ...
                    return function (t, n) {
                        p(t.a);
                        var e = t.a.f;
                        return e ? y(t, "return" in e ? e.return : function (t) {
                            return {
                                value: t,
                                done: !0
                            }
                        }, n, t.a.return) : (t.a.return(n), g(t))
                    }(t, n)
            ...
            function b(t, n) {
                var e = new m(new d(n));
                return l && l(e, t.prototype), e
            }
            if (h.prototype.i = function (t) {
                    this.m = t
                    ...
                    return p(this.a), this.a.f ? y(this, this.a.f.next, t, this.a.i) : (this.a.i(t), g(this))
                }, d.prototype.j = function (t) {
                    return p(this.a), this.a.f ? y(this, this.a.f.throw, t, this.a.i) : (this.a.j(t), g(this))
                }, "undefined" != typeof Blob && ("undefined" == typeof FormData || !FormData.prototype.keys)) {
                var w = function (t, n) {
                        for (var e = 0; e < t.length; e++) n(t[e])
                    },
                    x = function (t, n, e) {
                        return n instanceof Blob ? [String(t), n, void 0 !== e ? e + "" : "string" == typeof n.name ? n.name : "blob"] : [String(t), String(n)]
                    },
                    S = function (t, n) {
                        if (t.length < n) throw new TypeError(n + " argument required, but only " + t.length + " present.")
                    },
                    _ = function (t) {
                        var n = a(t);
                        t = n.next().value;
                        var e = n.next().value;
                        return n = n.next().value, e instanceof Blob && (e = new File([e], n, {
                            type: e.type,
                            lastModified: e.lastModified
                        })), [t, e]
                    },
                    E = "object" == typeof globalThis ? globalThis : "object" == typeof window ? window : "object" == typeof self ? self : this,
                    A = E.FormData,
                    O = E.XMLHttpRequest && E.XMLHttpRequest.prototype.send,
                    F = E.Request && E.fetch,
                    M = E.navigator && E.navigator.sendBeacon,
                    T = E.Element && E.Element.prototype,
                    P = E.Symbol && Symbol.toStringTag;
                P && (Blob.prototype[P] || (Blob.prototype[P] = "Blob"), "File" in E && !File.prototype[P] && (File.prototype[P] = "File"));
                try {
                    new File([], "")
                } catch (t) {
                    E.File = function (t, n, e) {
                        return t = new Blob(t, e), e = e && void 0 !== e.lastModified ? new Date(e.lastModified) : new Date, Object.defineProperties(t, {
                            name: {
                                value: n
                            },
                            lastModifiedDate: {
                ...
                var j = function (t) {
                    ...
                    t && w(t.elements, (function (t) {
                        if (t.name && !t.disabled && "submit" !== t.type && "button" !== t.type && !t.matches("form fieldset[disabled] *"))
                            if ("file" === t.type) {
                                var e = t.files && t.files.length ? t.files : [new File([], "", {
                                    type: "application/octet-stream"
                                })];
                                w(e, (function (e) {
                                    n.append(t.name, e)
                                }))
                            } else "select-multiple" === t.type || "select-one" === t.type ? w(t.options, (function (e) {
                                !e.disabled && e.selected && n.append(t.name, e.value)
                            })) : "checkbox" === t.type || "radio" === t.type ? t.checked && n.append(t.name, t.value) : (e = "textarea" === t.type ? t.value.replace(/\r\n/g, "\n").replace(/\n/g, "\r\n") : t.value, n.append(t.name, e))
                    }))
                };
                if ((n = j.prototype).append = function (t, n, e) {
                        S(arguments, 2), this.c.push(x(t, n, e))
                    }, n.delete = function (t) {
                        S(arguments, 1);
                        var n = [];
                        t = String(t), w(this.c, (function (e) {
                            e[0] !== t && n.push(e)
                        })), this.c = n
                    }, n.entries = function t() {
                        var n, e = this;
                        return b(t, (function (t) {
                            if (1 == t.b && (n = 0), 3 != t.b) return n < e.c.length ? t = v(t, _(e.c[n])) : (t.b = 0, t = void 0), t;
                            n++, t.b = 2
                        }))
                    }, n.forEach = function (t, n) {
                        S(arguments, 1);
                        for (var e = a(this), r = e.next(); !r.done; r = e.next()) {
                            var o = a(r.value);
                            r = o.next().value, o = o.next().value, t.call(n, o, r, this)
                        }
                    }, n.get = function (t) {
                        S(arguments, 1);
                        var n = this.c;
                        t = String(t);
                        for (var e = 0; e < n.length; e++)
                            if (n[e][0] === t) return _(n[e])[1];
                        return null
                    }, n.getAll = function (t) {
                        S(arguments, 1);
                        var n = [];
                        return t = String(t), w(this.c, (function (e) {
                            e[0] === t && n.push(_(e)[1])
                        })), n
                    }, n.has = function (t) {
                        S(arguments, 1), t = String(t);
                        for (var n = 0; n < this.c.length; n++)
                            if (this.c[n][0] === t) return !0;
                        return !1
                    }, n.keys = function t() {
                        var n, e, r, o, i = this;
                        return b(t, (function (t) {
                            if (1 == t.b && (n = a(i), e = n.next()), 3 != t.b) return e.done ? void(t.b = 0) : (r = e.value, o = a(r), v(t, o.next().value));
                            e = n.next(), t.b = 2
                        }))
                    }, n.set = function (t, n, e) {
                        S(arguments, 2), t = String(t);
                        var r = [],
                            o = x(t, n, e),
                            i = !0;
                        w(this.c, (function (n) {
                            n[0] === t ? i && (i = !r.push(o)) : r.push(n)
                        })), i && r.push(o), this.c = r
                    }, n.values = function t() {
                        var n, e, r, o, i = this;
                        return b(t, (function (t) {
                            if (1 == t.b && (n = a(i), e = n.next()), 3 != t.b) return e.done ? void(t.b = 0) : (r = e.value, (o = a(r)).next(), v(t, o.next().value));
                            e = n.next(), t.b = 2
                        }))
                    }, j.prototype._asNative = function () {
                        for (var t = new A, n = a(this), e = n.next(); !e.done; e = n.next()) {
                            var r = a(e.value);
                            e = r.next().value, r = r.next().value, t.append(e, r)
                        }
                        return t
                    }, j.prototype._blob = function () {
                        for (var t = "----formdata-polyfill-" + Math.random(), n = [], e = a(this), r = e.next(); !r.done; r = e.next()) {
                            var o = a(r.value);
                            r = o.next().value, o = o.next().value, n.push("--" + t + "\r\n"), o instanceof Blob ? n.push('Content-Disposition: form-data; name="' + r + '"; filename="' + o.name + '"\r\nContent-Type: ' + (o.type || "application/octet-stream") + "\r\n\r\n", o, "\r\n") : n.push('Content-Disposition: form-data; name="' + r + '"\r\n\r\n' + o + "\r\n")
                        }
                        return n.push("--" + t + "--"), new Blob(n, {
                    ...
                    }, T && !T.matches && (T.matches = T.matchesSelector || T.mozMatchesSelector || T.msMatchesSelector || T.oMatchesSelector || T.webkitMatchesSelector || function (t) {
                        for (var n = (t = (this.document || this.ownerDocument).querySelectorAll(t)).length; 0 <= --n && t.item(n) !== this;);
                        return -1 < n
                    }), P && (j.prototype[P] = "FormData"), O) {
                    var L = E.XMLHttpRequest.prototype.setRequestHeader;
                    E.XMLHttpRequest.prototype.setRequestHeader = function (t, n) {
                        L.call(this, t, n), "content-type" === t.toLowerCase() && (this.s = !0)
                    }, E.XMLHttpRequest.prototype.send = function (t) {
                        t instanceof j ? (t = t._blob(), this.s || this.setRequestHeader("Content-Type", t.type), O.call(this, t)) : O.call(this, t)
                    }
                }
                F && (E.fetch = function (t, n) {
                    return n && n.body && n.body instanceof j && (n.body = n.body._blob()), F.call(this, t, n)
                }), M && (E.navigator.sendBeacon = function (t, n) {
                    return n instanceof j && (n = n._asNative()), M.call(this, t, n)
                }), E.FormData = j
            }
        }()
    }).call(this, e(122))
    ...
    var r = function (t) {
            ...
            "function" != typeof n.matches && (n.matches = n.msMatchesSelector || n.mozMatchesSelector || n.webkitMatchesSelector || function (t) {
                for (var n = (this.document || this.ownerDocument).querySelectorAll(t), e = 0; n[e] && n[e] !== this;) ++e;
                return Boolean(n[e])
        ...
        o = (e(314), function () {
            var t = document.querySelector("#timer-hours"),
                n = document.querySelector("#timer-minutes"),
                e = document.querySelector("#timer-seconds");
            setInterval((function (r) {
                var o = function (t) {
                    var n = (new Date(t).getTime() - (new Date).getTime()) / 1e3;
                    return {
                        dateDifference: n,
                ...
                o.dateDifference > 0 ? (t.textContent = o.hours > 9 ? "".concat(o.hours) : "0".concat(o.hours), n.textContent = o.minutes > 9 ? "".concat(o.minutes) : "0".concat(o.minutes), e.textContent = o.seconds > 9 ? "".concat(o.seconds) : "0".concat(o.seconds)) : (t.textContent = "00", n.textContent = "00", e.textContent = "00")
            }), 1e3, "17 july 2020")
        }),
        i = e(60),
        u = e.n(i),
        c = function () {
            var t = document.querySelector("a[href='#service-block']");
        ...
        a = function () {
            var t = document.querySelector("menu"),
                n = function () {
                    return t.classList.toggle("active-menu")
                };
            document.body.addEventListener("click", (function (e) {
                var r = e.target;
                if (r.classList.contains("close-btn") || r.closest(".menu")) return n();
                if (!r.closest(".active-menu") && t.classList.contains("active-menu")) return n();
                if (r = r.closest("menu>ul>li>a")) {
                    e.preventDefault();
        ...
        s = function () {
            ...
            n.forEach((function (n) {
                return n.addEventListener("click", (function () {
                    t.style.display = "block", document.body.clientWidth >= 768 && function n() {
                        if (r >= 1.5) return r = 0, cancelAnimationFrame(e);
                        r += .014, t.style.opacity = r, e = requestAnimationFrame(n)
                    }()
                }))
            })), t.addEventListener("click", (function (n) {
                var e = n.target;
                e.classList.contains("popup-close") ? t.style.display = "none" : (e = e.closest(".popup-content")) || (t.style.display = "none")
            }))
        };
    ...
    var h = function () {
        var t = document.querySelector(".service-header"),
            n = t.querySelectorAll(".service-header-tab"),
            e = document.querySelectorAll(".service-tab");
        t.addEventListener("click", (function (t) {
            var r, o = t.target.closest(".service-header-tab");
            o && (r = f(n).indexOf(o), e.forEach((function (t, e) {
                r === e ? (t.classList.remove("d-none"), n[e].classList.add("active")) : (t.classList.add("d-none"), n[e].classList.remove("active"))
            })))
        }))
    };
    ...
    function p(t) {
        return function (t) {
            ...
            "Object" === e && t.constructor && (e = t.constructor.name);
            if ("Map" === e || "Set" === e) return Array.from(t);
            if ("Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return v(t, n)
        }(t) || function () {
            throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")
        }()
    }
    ...
    var d = function () {
            var t, n = document.querySelectorAll(".portfolio-item"),
                e = (document.querySelectorAll("portfolio-btn"), document.querySelector(".portfolio-content")),
                r = document.querySelectorAll(".dot"),
                o = 0,
                i = function (t, n) {
                    return t.classList.toggle(n)
                },
                u = function () {
                    i(n[o], "portfolio-item-active"), i(r[o], "dot-active"), ++o >= n.length && (o = 0), i(n[o], "portfolio-item-active"), i(r[o], "dot-active")
                },
                c = function () {
                    return t = setInterval(u, 1500)
                };
            e.addEventListener("click", (function (t) {
                t.preventDefault();
                var e = t.target;
                e.matches(".portfolio-btn, .dot") && (i(n[o], "portfolio-item-active"), i(r[o], "dot-active"), e.matches("#arrow-right") ? o++ : e.matches("#arrow-left") ? o-- : e.matches(".dot") && (o = p(e.parentNode.children).indexOf(e)), o >= n.length ? o = 0 : o < 0 && (o = n.length - 1), i(n[o], "portfolio-item-active"), i(r[o], "dot-active"))
            })), e.addEventListener("mouseover", (function (n) {
                n.target.matches(".portfolio-btn, .dot") && clearInterval(t)
            })), e.addEventListener("mouseout", (function (t) {
                t.target.matches(".portfolio-btn, .dot") && c()
            }));
            n.forEach((function (t, n) {
                var e = document.createElement("li");
                e.classList.add("dot"), 0 === n && e.classList.add("dot-active"), document.querySelector(".portfolio-dots").append(e)
            })), r = document.querySelectorAll(".dot"), c(1500)
        },
        y = function () {
            var t = document.querySelector(".command>.container>.row"),
                n = function (t) {
                    var n = t.target;
                    if (n.classList.contains("command__photo")) {
                        var e = n.src;
                        n.src = n.dataset.img, n.dataset.img = e
                    }
                };
            t.addEventListener("mouseover", n), t.addEventListener("mouseout", n)
        },
        g = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 100,
                n = document.querySelector(".calc-block"),
                e = document.querySelector(".calc-type"),
                r = document.querySelector(".calc-square"),
                o = document.querySelector(".calc-day"),
                i = document.querySelector(".calc-count"),
                u = document.getElementById("total"),
                c = function (t, n) {
                    var e = {
                        id: -1,
                    ...
                    t.textContent > n && (e.direction = !1);
                    var r = performance.now();
                    e.id = requestAnimationFrame((function o(i) {
                        if (i - r > e.duration) return cancelAnimationFrame(e.id);
                        var u = Math.ceil((i - r) % e.duration),
                            c = e.progress + (e.direction ? u : -u);
                        e.direction && c > n || !e.direction && c <= n ? (e.progress = n, cancelAnimationFrame(e.id)) : (e.progress = c, e.id = requestAnimationFrame(o)), t.textContent = e.progress
                    }))
                },
                a = function () {
                    var n = 0,
                        ...
                        f = 1,
                        l = 1;
                    i.value > 1 && (f += (i.value - 1) / 10), o.value && o.value < 5 ? l *= 2 : o.value && o.value < 10 && (l *= 1.5), a && s && (n = Math.ceil(t * a * s * f * l), c(u, n))
                };
            n.addEventListener("change", (function (t) {
                var n = t.target;
                "INPUT" !== n.tagName && "SELECT" !== n.tagName || a()
            }))
        };
    ...
    var w = function () {
        ...
        t.style.cssText = "font-size: 2rem;";
        document.body.addEventListener("submit", (function (n) {
            if ("form" === n.target.tagName.toLowerCase()) {
                n.preventDefault();
                var e, r = n.target;
                t === r.lastElementChild && (r.lastElementChild.remove(), t.textContent = ""), r.append(t),
                    function (t) {
                        t.insertAdjacentHTML("beforeend", '   \n            <div class="spinner">\n                <div class="cube1"></div>\n                <div class="cube2"></div>\n            </div>')
                    }(r), (e = new FormData(r), fetch("../server.php", {
                        method: "POST",
                        mode: "same-origin",
                        cache: "default",
                        headers: {
                        ...
                        if (200 !== n.status) throw new Error("invalid server response status");
                        t.textContent = "Спасибо! Ваша заявка отправлена на обработку", r.lastElementChild.remove(), m(r.querySelectorAll("input")).forEach((function (t) {
                            "input" === t.tagName.toLowerCase() && (t.value = "")
                        }))
                    })).catch((function (n) {
                        t.textContent = "Что-то пошло не так", console.error(n), m(r.querySelectorAll("input")).forEach((function (t) {
                            "input" === t.tagName.toLowerCase() && (t.value = "")
                        }))
                    }))
            }
    ...
    r(window), o(), c(), a(), s(), h(), d(), y(), g(100), w()
}]);